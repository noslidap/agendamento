  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <section className="py-20 text-center text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-yellow-400 bg-clip-text text-transparent">
              Agende seu Horário
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button 
                ...
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-bold px-8 py-4 text-lg shadow-xl transform hover:scale-105 transition-all duration-200"
              >
              ...
              <Button 
                ...
                className="border-white text-white hover:bg-white hover:text-black px-8 py-4 text-lg transition-all duration-200"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">Agendamento Rápido</h4>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">Gestão Profissional</h4>
                <p className="text-gray-300">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">Experiência Premium</h4>
                <p className="text-gray-300">
      ...
      <footer className="py-8 bg-black/30 text-center text-gray-400">
        <div className="container mx-auto px-4">
          <p>&copy; 2024 BarberApp. Sistema profissional de agendamento para barbearias.</p>
        </div>
      </footer>
